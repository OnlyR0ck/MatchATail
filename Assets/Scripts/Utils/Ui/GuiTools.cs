...
namespace UnityEngine.UI.Extensions
{
    public static class GuiTools
    {
        ...
        static void MirrorHorizontallyAnchors() => MirrorHorizontally(false);


        [MenuItem("uGUI/Mirror Horizontally Around Parent Center %:")]
        static void MirrorHorizontallyParent() => MirrorHorizontally(true);
        ...
        static void MirrorVerticallyAnchors() => MirrorVertically(false);


        [MenuItem("uGUI/Mirror Vertically Around Parent Center %\"")]
        static void MirrorVerticallyParent() => MirrorVertically(true);
